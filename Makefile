...
Vorta.dmg: Vorta.app
	# sleep 2; cd dist; zip -9rq vorta-0.5.0.zip Vorta.app
	rm -rf dist/vorta-0.5.0.dmg
	sleep 2; appdmg appdmg.json dist/vorta-0.5.0.dmg
...
pypi-release:
	...
	twine upload dist/vorta-0.5.0.tar.gz
